...
function generateHeader(doc) {
  doc
    .image("1.jpg", 50, 45, { width: 50 })
    .fillColor("#444444")
    .fontSize(20)
    .text("Shaltout", 110, 57)
    .fillColor("#09c")
    .fontSize(10)
    .text("Shaltout", 200, 50, { align: "right" })
    .text("47 amin  street", 200, 65, { align: "right" })
...
function generateFooter(doc) {
  doc
    .fontSize(10)
    .text("Payment is due within 15 days. Thank you. Shaltout.", 50, 780, {
      align: "center",
      width: 500,
    });
}
